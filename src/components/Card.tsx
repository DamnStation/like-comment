        ...
        <div className="flex flex-col justify-between w-[602px] h-[228px] my-[19px] bg-white rounded-md shadow-[0_4px_5px_rgba(123,124,129,0.5)]">
            <div className="flex flex-row w-full">
                ...
                <div className="flex flex-col w-3/5 pt-[17px]">
                    <div>Daniel Goshev</div>
                    <div>Software Developer, HackSoft</div>
                </div>
                <div className="flex pl-16 pt-3 font-normal text-sm">20 minutes ago</div>
            </div>
            <div className="font-normal text-base w-[539px] h-[66px] py-4 pl-[15px] pr-12" >Despite our total project numbers only increasing by 2% compared to last month, the 58 projects we are working on contain a significant increase in deliverables.</div>
            <div className="flex flex-row pl-[14px] pt-7 pb-[11px]">
                <img src={LikedIcon} alt="People liked this post" className="h-[18px] w-[18px]" />
            </div>
            <div className="flex justify-between px-[15px] pt-2 pb-[11px] border-t border-profile-border">
                <ButtonCusom
                    buttonStyle="bg-none "
